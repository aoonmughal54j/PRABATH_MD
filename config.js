...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/19c9c1cb2216920bfd8c7.jpg'
module.exports = {
  OPENAI_API_KEY:process.env.OPENAI_API_KEY || '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',
  botname: process.env.BOT_NAME || '✦Ｊ Ｅ Ｅ Ｒ Ｙ✦ ,
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '923465125306',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/19c9c1cb2216920bfd8c7.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY 𝙼𝙳-Ｊ Ｅ Ｅ Ｒ Ｙ* 🎊',
  ownername:process.env.OWNER_NAME || 'Ｊ Ｅ Ｅ Ｒ Ｙ,
  sessionName: process.env.SESSION_ID || 'p7cmUCgR#lgANAK1v8gfIqvbgLcxU5skZ-XOjjM_sbXW-7Mb47S4,
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true,
  packname: process.env.PACK_INFO.split(";")[1] || 'Ｊ Ｅ Ｅ Ｒ Ｙ,
